<div class="card card-body my-2 ">
    ...
    <form action="{{route('profile.store')}}" method="POST">
        ...
        <x-form.input-component helpText="يحتاج توثيق الحساب" name="face" :value="old('face')??auth()->user()->social['face']" label="رابط فيس بوك" :disabled="!auth()->user()->is_verified" placeholder="رابط فيس بوك" type="url"/>
