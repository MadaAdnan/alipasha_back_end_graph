<div class="card card-body my-2 ">
    ...
    <form action="{{route('profile.store')}}" method="POST">
        ...
        <x-form.input-component name="seller_name" @if(!auth()->user()->is_verified)  disabled  @endif :value="old('seller_name')??auth()->user()->seller_name" label="اسم المتجر" placeholder="اسم المتجر" required/>
