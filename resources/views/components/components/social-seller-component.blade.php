...
@if($store->plans()->whereNot('duration','free')->exists() && $hasSocial)
    <div class="social-media-section text-center py-4">
        ...
        <div class="social-links d-flex justify-content-center gap-3 flex-wrap">
            @if(Str::startsWith($store->social['face'],'https://'))
            ...
            @endif
            @if(Str::startsWith($store->social['twitter'],'https://'))
            ...
            @endif
            @if(Str::startsWith($store->social['instagram'],'https://'))
            ...
            @endif
            @if(Str::startsWith($store->social['linkedin'],'https://'))
            ...
            @endif
            @if(Str::startsWith($store->social['tiktok'],'https://'))
