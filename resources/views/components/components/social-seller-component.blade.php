...
@endphp
@if($store->plans()->whereNot('duration','free')->exists() && $hasSocial)
    <div class="social-media-section text-center py-4">
        ...
        <div class="social-links d-flex justify-content-center gap-3 flex-wrap">
            @if(Str::startsWith('https://',$store->social['face']))
            ...
            @endif
            @if(Str::startsWith('https://',$store->social['twitter']))
            ...
            @endif
            @if(Str::startsWith('https://',$store->social['instagram']))
            ...
            @endif
            @if(Str::startsWith('https://',$store->social['linkedin']))
            ...
            @endif
            @if(Str::startsWith('https://',$store->social['tiktok']))
