...
@section('title')
    {{$post->name ?? Str::words($post->expert,2)}}
@endsection
@section('content')
    ...
    \App\Enums\CategoryTypeEnum::PRODUCT->value,
                      ...
                      "
                                ...
                                <div style="display: flex; justify-content: end;margin: 20px 0px;">
                                    <div class="post-info">
                                        <div style="display: flex; gap: 4px; flex-direction: column">
                                            <p class="title" style="text-align: right">{{$post->user?->seller_name}} @if($post->user?->is_verified)    <i class="bi bi-patch-check" style="color: blue; font-size: 16px;"></i> @endif</p>
