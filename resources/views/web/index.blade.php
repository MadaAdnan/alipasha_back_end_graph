                                        ...
                                        >
                                            <a href="{{route('communities.show',$community->id)}}"
                                               class="rounded-circle">
                                                <img class="rounded-circle" width="45" src="@if($community->hasMedia('image') && $community->type!=\App\Enums\CommunityTypeEnum::CHAT->value) {{$community->getImage()}} @else {{$community->users()->where('users.id','!=',auth()->id())->first()?->getImage()}}  @endif "
