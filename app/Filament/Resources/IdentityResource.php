    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\SpatieMediaLibraryImageColumn::make('front')->collection('front')->conversion('web'),
                Tables\Columns\SpatieMediaLibraryImageColumn::make('back')->collection('back')->conversion('web'),
                Tables\Columns\TextColumn::make('id')->label('#'),
            ])
            ->filters([
                //
