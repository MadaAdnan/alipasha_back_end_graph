...
class ProductResource extends Resource
{
    ...
    {
        return (string)Product::product()->where('active', OrderStatusEnum::PENDING->value)->count();
    }
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('المنتجات')->schema([
                    Forms\Components\Select::make('user_id')->options(User::seller()->selectRaw('id,seller_name')->pluck('seller_name', 'id'))->label('المتجر')
                        ->searchable()->live()
                    ...
                    SpatieMediaLibraryFileUpload::make('image')->collection('image')->conversion('webp')->label('الصورة الرئيسية')->image()
                        ->imageEditor()
                        ->imageCropAspectRatio("1:1")->openable()->downloadable()->deletable() ,
                    ...
                    Forms\Components\Fieldset::make('الأسعار والتوفر')->schema([
                        ...
                        Forms\Components\Grid::make()->schema([
                            ...
                            Forms\Components\TextInput::make('power')->numeric()->minValue(0)->maxValue(100)->integer()->label('جودة المنتج')->required(),
                        ]),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('user.seller_name')->wrap()->label('المتجر')->url(fn($record) =>$record->user_id!=null? UserResource::getUrl('edit', ['record' => $record->user_id]):null)->searchable(),
            ...
            ->filters([
                ...
                Tables\Filters\Filter::make('category_filter')->form([
                    Forms\Components\Select::make('category_id')
                        ->options(Category::where('categories.is_main', true)->pluck('name', 'id'))
