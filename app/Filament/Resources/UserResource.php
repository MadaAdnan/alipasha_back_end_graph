...
//                                Forms\Components\SpatieMediaLibraryFileUpload::make('image')->collection('image')->conversion('webp')->imageCropAspectRatio('1:1')->imageEditor()->columnSpan(2),
                                ...
                                PhoneInput::make('phone')
                                    ->countryStatePath('country_code')->displayNumberFormat(PhoneInputNumberType::INTERNATIONAL)->label('رقم الهاتف'),
        ...
        return $table
            ...
            ->columns([
                ...
                PhoneColumn::make('phone')
                    ->countryColumn('country_code')->displayFormat(PhoneInputNumberType::E164)->url(fn($record)=>'https://wa.me/'.ltrim($record->phone,'+'),true),
