        ...
        return $form
            ->schema([
                Forms\Components\Section::make('المجتمعات')->schema([
                    ...
                    Forms\Components\Select::make('manager_id')->getSearchResultsUsing(fn(string $search)=>User::selectRaw('id,name')->where('name','like',"%$search%")->take(10)->pluck('name','id')->toArray())->required()->searchable()->label('المدير الرئيسي'),
