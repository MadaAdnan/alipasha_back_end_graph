...
class VendorResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\TextColumn::make('name')->url(fn($record)=>UserResource::getUrl('edit',['record'=>$record->id]),true),
                Tables\Columns\TextColumn::make('products_count')->label('المنتجات')->url(fn($record)=>UserResource::getUrl('edit',['record'=>$record->id]),true),
