    ...
    public static function getPermissionPrefixes(): array
    {
        return [
           'view_any_services',
            ...
            'restore_services',
            'force_delete_services'
        ];
    }

        public static function canAccess(): bool
    {
        return parent::canAccess() && auth()->user()?->can('view_any_services'); // TODO: Change the autogenerated stub
    }

    public static function canCreate(): bool
    {
        return parent::canCreate() && auth()->user()?->can('create_services'); // TODO: Change the autogenerated stub
    }

    public static function canDelete(Model $record): bool
    {
        return parent::canDelete($record) && auth()->user()?->can('delete_services'); // TODO: Change the autogenerated stub
    }

    public static function canDeleteAny(): bool
    {
        return parent::canDeleteAny() && auth()->user()?->can('delete_services'); // TODO: Change the autogenerated stub
    }

    public static function canView(Model $record): bool
    {
        return parent::canView($record) && auth()->user()?->can('view_any_services'); // TODO: Change the autogenerated stub
    }

    public static function canViewAny(): bool
    {
        return parent::canViewAny() && auth()->user()?->can('view_any_services'); // TODO: Change the autogenerated stub
    }

    public static function canRestoreAny(): bool
    {
        return parent::canRestoreAny() && auth()->user()?->can('restore_services'); // TODO: Change the autogenerated stub
    }

    public static function canEdit(Model $record): bool
    {
        return parent::canEdit($record) && auth()->user()?->can('update_services'); // TODO: Change the autogenerated stub
    }

    public static function canForceDeleteAny(): bool
    {
        return parent::canForceDeleteAny() && auth()->user()?->can('force_delete_services'); // TODO: Change the autogenerated stub
    }

    public static function canRestore(Model $record): bool
    {
        return parent::canRestore($record) && auth()->user()?->can('restore_services'); // TODO: Change the autogenerated stub
    }

    public static function canForceDelete(Model $record): bool
    {
        return parent::canForceDelete($record) && auth()->user()?->can('force_delete_services'); // TODO: Change the autogenerated stub
    }
