...
use App\Filament\Seller\Resources\TenderResource\Pages;
use App\Filament\Seller\Resources\TenderResource\RelationManagers;
...
class TenderResource extends Resource
{
    ...
    {
        return $table
            ->modifyQueryUsing(fn($query) => $query->tender()->where('user_id',auth()->id())->orderByDesc('end_date'))
            ->columns([
